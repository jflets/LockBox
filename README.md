...
| **Feature**                               | **Expected Outcome**                                                                                                                                                      | **Testing Performed**                               | **Result**                                                                                         | **Pass/Fail** |
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------- |
| Blank input for username                  | User should be prompted that they cannot enter blank as a user name.                                                                                                      | Entered blank for username                          | Prompted to re-enter a valid username as username cannot be blank.                                 | Pass          |
| Blank master password/ password           | User should be prompted that their password needs to be at least 4 characters and contain 1 special character                                                             | Press enter with blank master password/ password    | Prompted to enter a master password/ password at least 4 characters long with 1 special character. | Pass          |
| Entering blank spaces inside the password | User should not be able to enter blank/ whitespace keys                                                                                                                   | Attempt to enter blank/ whitespace keys in password | Nothing happened I was unable to enter blank/ whitespace keys.                                     | Pass          |
| Generating a random password (min length) | User should not be able to enter a length less than 8 and should be prompted that the minimum length is 8, ask user to re-enter length.                                   | Enter length less than 8                            | Prompted that the minimum length is 8 asked to re-enter length.                                    | Pass          |
| Generating a random password (max length) | User should not be able to enter password length more than 14 and should be prompted that the max length is 14 and a password has been generated with 14 characters.      | Enter length more than 14                           | Prompted that the max length is 14 and a password has been generated with a length of 14.          | Pass          |
| Login attempts                            | User should get 2 attempts to enter the correct login information and if they fail they should be prompted to create a new account y/n, both options restart the program. | Enter invalid login information twice               | Prompted to create new account and program restarted.                                              | Pass          |
